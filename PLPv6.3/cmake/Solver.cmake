...
if (COIN_USE_GRB)
  ...
  if (GUROBI_FOUND)
    ...
    set (SOLVER_LIBRARIES "${SOLVER_LIBRARIES};${GUROBI_LIBRARIES}")

    find_package(OsiGrb)
    if (OSIGRB_FOUND)
      SET(COIN_OSI_LIBRARIES "${COIN_OSIGRB_LIBRARY};${COIN_OSI_LIBRARIES}")
    endif()
    
    set(SOLVER_DEFINE "-DCOIN_USE_GRB")
  endif()
endif()
