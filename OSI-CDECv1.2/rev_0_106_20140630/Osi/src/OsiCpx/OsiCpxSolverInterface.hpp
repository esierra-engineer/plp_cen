...
public:
  ...
  */
  //@{
    ...
    //@{
      ...
      */
      ...
      /// Get a coefficient from the restriction matrix.
      virtual double getCoefficient(int rowIndex, int colIndex) const;
    ...
    //@{
      ...
      */
      ...
      /* extreme ray used to build a feasibility cut */
      virtual int getExtremeRay(double *y, double *rhs);
#if 0
  ...
  //@{
    ...
    //@{
      ...
      virtual void setCoefficient(int rowIndex, int columnIndex, double elementValue);
  ...
  //@{
    ...
    */
    ...
    virtual void writeLps(const char *filename,
			  const char *extension = "lp") const;
  ...
  */
  ...
  /// Copy constructor with copyData
  OsiCpxSolverInterface( const OsiCpxSolverInterface&, bool copyData);
...
private:
  ...
  void gutsOfCopy( const OsiCpxSolverInterface & source, bool copyData = true );
