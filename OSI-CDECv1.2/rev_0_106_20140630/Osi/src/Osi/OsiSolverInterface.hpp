...
public:
  ...
  */
  //@{
    ...
    */
    ...
    /*! \brief Get a coefficient from the restriction matrix.
    */
  ...
  //@{
    ...
    */
    ...
    virtual int getExtremeRay(double *ray, double *rhs);
  ...
  */
  //@{
    /** Set a restriction matrix coeficient */
    virtual void setCoefficient(int rowIndex, int colIndex, double value) ;
