...
enum OsiDblParam {
  ...
  */
  ...
  /** The time limit for the solver, if any. */
  OsiTimeLimit,

  /** The relative gap allowed for MIP problems, if any. */
  OsiMIPGap,

  /*! \brief Barrier feasibility tolerance.
  ...
  */
  ...
  /** The value of  the objective function range. */
  OsiObjRange,
...
enum OsiHintParam {
  ...
  OsiDoDualInInitial,
  /** Whether to use a barrier algorithm in initialSolve. */
  OsiDoBarrierInInitial,
  /** Whether to use a netopt algorithm in initialSolve. */
  OsiDoNetoptInInitial,
  /** Whether to do a presolve in resolve */
  OsiDoPresolveInResolve,
  /** Whether to use a dual algorithm in resolve.
      The reverse is to use a primal algorithm */
  OsiDoDualInResolve,
  /** Whether to use a barrier algorithm in resolve. */
  OsiDoBarrierInResolve,
  /** Whether to use a netopt algorithm in resolve. */
  OsiDoNetoptInResolve,
